	...
	<div class="limiter">
      ...
      <div id='cssmenu'>
        <ul id='bar'>          <li><a href='/demeter/home'>Expiry Sort</a></li>
          <li class='active'><a href='/demeter/recipe'>Category Sort</a></li>
      ...
      <h1 class="user__title">Category Sort</h1>
      <br>
      <h2 class="caption">These recipes are sorted by category and inventory availability</h2>
